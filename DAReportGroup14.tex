...
% table format to display our Details

% \begin{table}[htbp]
%   \centering
%   \caption{Group Member Details}
%   \label{tab:group_member_details}
%   \begin{tabular}{|l|l|}
%     \hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\pagebreak
\import{Sections/}{data_mining.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Data Visualisation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\pagebreak
\import{Sections/}{data_visualisation.tex}
