...
% Read the objective properly. intention is to apply 3d not to create a model 
...
\[
\text{First Path Power Level} = 10 \cdot \log_{10}\left(\frac{{FP\_AMP1^2 + FP\_AMP2^2 + FP\_AMP3^2}}{{RXPACC^2}}\right) - STDEV\_NOISE  % damn sick wtf jw korkor <3
\]
...
% No Pls Im going to include other stuff here. Don't add random things here.
...
% Some definitions can remove, put here first %
